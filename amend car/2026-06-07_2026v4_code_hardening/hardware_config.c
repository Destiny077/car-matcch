...
#define ROBOT_ROUTE_MAX_SPEED 32.0
#define ROBOT_ROUTE_TURN_SPEED_LIMIT 32.0
#define ROBOT_ROUTE_SETTLE_SEC 0.10

/* AprilTag alignment profile. */
#define ROBOT_TAG_DIST_THRESHOLD 35.0
#define ROBOT_TAG_SPEED_HIGH 14.0
#define ROBOT_TAG_SPEED_LOW 2.0
#define ROBOT_TAG_VW_LIMIT 12.0
#define ROBOT_TAG_X_TOLERANCE 12.0
#define ROBOT_TAG_Y_TOLERANCE 12.0
#define ROBOT_TAG_A_TOLERANCE 6.0
#define ROBOT_A1_SEEN_CONFIRM_LOOPS 12

...
#define ROBOT_ROUTE_MAX_SPEED 24.0
#define ROBOT_ROUTE_TURN_SPEED_LIMIT 26.0
#define ROBOT_ROUTE_SETTLE_SEC 0.18
#define ROBOT_ROUTE_SEGMENT_CM 24.0
#define ROBOT_ROUTE_ENCODER_BALANCE_GAIN 0.03
#define ROBOT_ROUTE_ENCODER_BALANCE_LIMIT 5
#define ROBOT_MOVE_CONTROL_PERIOD_SEC 0.01
#define ROBOT_ROUTE_RAMP_CM 8.0
#define ROBOT_ROUTE_RAMP_MIN_SPEED 12
...
#define ROBOT_A1_SEEN_CONFIRM_LOOPS 24
#define ROBOT_A1_TAG_WARMUP_SEC 0.40
#define ROBOT_TAG_RETRY_COUNT 2
#define ROBOT_TAG_NAV_CONFIRM_LOOPS 3
